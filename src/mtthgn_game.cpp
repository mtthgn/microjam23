...
namespace mtthgn
{
  ...
  {
    bn::point new_player_tile_position = _player_tile_position;
    ...
    result.exit = data.pending_frames == 0;
      ...
      if(!_victory && !_defeat)
      {
        ...
        {
          new_player_tile_position.set_x(new_player_tile_position.x() - 1);
        ...
        {
          new_player_tile_position.set_y(new_player_tile_position.y() - 1);
        ...
        bn::point next_cell_point = bn::point(
          (new_player_tile_position.x() + (_map_item.dimensions().width() * 4) -4)/ 8,
          (new_player_tile_position.y() + (_map_item.dimensions().height() * 4) - 4)/ 8);
        ...
        {
          bn::point current_cell_point = bn::point(
          (_player_tile_position.x() + (_map_item.dimensions().width() * 4) -4)/ 8,
          (_player_tile_position.y() + (_map_item.dimensions().height() * 4) - 4)/ 8);
